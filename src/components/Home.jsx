...
const Home = ({ user }) => {
    ...
    const handleBrandFilterClick = (brand) => {
        setSearchQuery(brand); // Apply the brand as a filter
    };

    const handleModelFilterClick = (model) => {
        setSearchQuery(model); // Apply the model as a filter
    };
            ...
            <div className="banner-component">
                <div className="cover-component">
                    <div className="img-sliders">
                        <img src="./img/phone.jpg" alt="" ref={e => refSliders.current.push(e) } />
                    </div>
                    <div className="img-sliders abs">
                        <img src="./img/phone2.jpg" alt="" ref={e => refSliders.current.push(e)}/>
                    </div>
                    <div className="img-sliders abs">
                        <img src="./img/phone3.jpg" alt="" ref={e => refSliders.current.push(e)}/>
                    </div>
                </div>
                <div className="box-text">
                    <div className="slide-text">
                        <h5 ref={e => textRefs.current.push(e)}> Vivo </h5>
                        <h5 ref={e => textRefs.current.push(e)} className='abs'> Xiaomi </h5>
                        <h5 ref={e => textRefs.current.push(e)} className='abs'> ROG </h5>
                    </div>
                </div>
            </div>
