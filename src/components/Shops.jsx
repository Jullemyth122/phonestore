...
const Shops = ({ user }) => {
    ...
    // }, [searchQuery, brandFilter, modelFilter, selectedPriceRange, selectedSellerRange, listItem]);
        ...
        <div className='shops-component'>
            ...
            <div className='products-component'>
                <div className="option-products">
                    <div className="br-md">
                        <div className="dropdowns" onClick={toggleBrandDropdown}>
                            <h4>
                                Brand
                            </h4>
                            ...
                            {isBrandOpen && (
                                <div className="shopsdown-content">
                                    {/* Dropdown content */}
                                    <p onClick={() => handleBrandFilterClick('Xiaomi')}> Xiaomi </p>
                                    <p onClick={() => handleBrandFilterClick('ROG')}> ROG </p>
                                    <p onClick={() => handleBrandFilterClick('Vivo')}> Vivo </p>
                                </div>
                            )}
                        </div>
                        <div className="dropdowns" onClick={toggleModelDropdown}>
                            <h4>Model</h4>
                            <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M0.46967 0.46967C0.762563 0.176777 1.23744 0.176777 1.53033 0.46967L6 4.93934L10.4697 0.46967C10.7626 0.176777 11.2374 0.176777 11.5303 0.46967C11.8232 0.762563 11.8232 1.23744 11.5303 1.53033L6.53033 6.53033C6.23744 6.82322 5.76256 6.82322 5.46967 6.53033L0.46967 1.53033C0.176777 1.23744 0.176777 0.762563 0.46967 0.46967Z" fill="white"/>
                            </svg>
                            {isModelOpen && (
                                <div className="shopsdown-content">
                                    {/* Dropdown content */}
                                    <p onClick={() => handleModelFilterClick('Express')}> Express </p>
                                    <p onClick={() => handleModelFilterClick('Vanilla')}> Vanilla </p>
                                    <p onClick={() => handleModelFilterClick('Bicol')}> Bicol </p>
                                </div>
                            )}
                        </div>
                        <div className="dropdowns" onClick={togglePriceDropdown}>
                            <h4> Price </h4>
                            {isPriceOpen && (
                                <div className="shopsdown-content">
                                    {/* Dropdown content */}
                                    <p onClick={() => handlePriceFilterClick('100 - 500')}> $ 100 - 500 </p>
                                    <p onClick={() => handlePriceFilterClick('500 - 2500')}> $ 500 - 2500 </p>
                                    <p onClick={() => handlePriceFilterClick('2500 - 10000')}> $ 2500 - 10000 </p>
                                </div>
                            )}
                        </div>
                        <div className="dropdowns" onClick={toggleBestSellerDropdown}>
                            <h4> Best Seller </h4>
                            {isSellerOpen && (
                                <div className="shopsdown-content">
                                    {/* Dropdown content */}
                                    <p onClick={() => handleBestSellerFilterClick('10 < 50')}> 10 - 50 </p>
                                    <p onClick={() => handleBestSellerFilterClick('50 < 100')}> 50 - 100 </p>
                                    <p onClick={() => handleBestSellerFilterClick('100 < 200')}> 100 - 200 </p>
                                </div>
                            )}
                        </div>
                    </div>
